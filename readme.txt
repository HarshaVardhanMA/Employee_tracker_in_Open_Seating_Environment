...
2. To run the executable, double click on the electronapp.exe file, present in the elecronapp direcrory(this executable works for windows now.. Similar executables can be easily built using the source code for other Operating systems, if required).
